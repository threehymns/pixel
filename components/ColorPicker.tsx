  ...
  return (
    <div className="flex flex-col gap-3 p-3 w-56 bg-card border border-border rounded-xl shadow-2xl">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-md border border-border overflow-hidden shrink-0 relative shadow-inner" style={{ backgroundColor: color }}>
           <input 
             type="color" 
             value={color} 
      ...
      <div className="grid grid-cols-8 gap-1 pt-2 border-t border-border">
        {['#000000', '#ffffff', '#ff0000', '#00ff00', '#0000ff', '#ffff00', '#00ffff', '#ff00ff', '#888888', '#ff8800', '#0088ff', '#88ff00', '#ff0088', '#00ff88', '#8800ff', '#444444'].map(c => (
          <button 
            key={c}
            className="w-full aspect-square rounded-sm border border-border hover:scale-110 transition-transform shadow-sm"
